...
$s="select * from camp,state,city where camp.state=state.state_id and camp.city=city.city_id";
    ...
    <table cellpadding="0" cellspacing="0" class="tableborder" width="500"height="500" style="display:inline-flex">
    <tr><td style="font-size:24px; font-weight:bold; text-shadow:1px 1px 6px browm; padding-left:10px; padding-top:10px; padding-bottom:10px; color:#925959"><?php echo $data[1]; ?></td></tr>
      <tr><td align="center"> 
   <a href="Admin/pic/<?php echo $data[5] ?>"data-lightbox="image-1"> <img src="Admin/pic/<?php echo $data[5] ?>" height="150px" width="110px" style="margin:auto; padding-left:100px; width:100%" /></a></td></tr>
