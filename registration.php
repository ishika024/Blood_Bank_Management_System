...
<table cellpadding="0" cellspacing="0" style="margin:auto; width:100%; " >
    ...
    <tr><td colspan="2"  align="center"><img src="Images/donor.png" width="300px" height="80px"  /></td>
	</tr>
	...
	<tr><td class="lefttd">Donor Name</td>
	...
	<tr><td class="lefttd"> Blood Group </td>
		<td><select name="t4" style="height: 20px; width:40%;"><option value="">Select Blood Group</option>
	<?php
		$cn=makeconnection();
	...
	<tr><td class="lefttd">E-Mail</td>
		<td><input type="email" name="t5" required="required" /></td>
	</tr>
	<tr><td class="lefttd">Password</td>
	...
	<tr><td class="lefttd">Confirm Password</td>
	...
	<tr><td class="lefttd">Uplode Pic</td>
